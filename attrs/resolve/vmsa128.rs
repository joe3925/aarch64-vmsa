...
use crate::attrs::{
    ...
    ResolvedStage2LeafAttrs, SemanticLeafAttrs, SemanticStage1LeafAttrs, SemanticStage2LeafAttrs,
    SemanticTableAttrs, SemanticVmsa128Stage1LeafControls, SemanticVmsa128Stage1TableAttrs,
    ...
    R::PasModel: Stage1PasResolver,
{
    fn encode_leaf(
        ...
        resolve_vmsa128_stage1_leaf_resolved::<R::PrivilegeModel, R::PasModel, Cfg>(
            config, level, attrs,
        )
    ...
    fn decode_leaf(
        ...
        decode_stage1_leaf::<R::PrivilegeModel, R::PasModel, Cfg>(config, level, raw)
    }
    ...
    R::PasModel: Stage2PasContext + Stage2PasResolver<Vmsa128, Cfg, Software = TenBit>,
{
    fn encode_leaf(
        ...
        resolve_vmsa128_stage2_leaf_resolved::<R::PasModel, Cfg>(config, level, attrs)
            .map(raw_vmsa128_stage2_leaf)
    }
    ...
    fn decode_leaf(
        ...
        decode_stage2_leaf::<R::PasModel, Cfg>(config, level, raw)
    }
