...
descriptor_layout! {
    ...
    fields {
        ...
        pub VMSA64_STAGE1_ATTR_INDEX_HIGH: Field<59, 1> in STAGE1_LEAF;
        pub VMSA64_STAGE1_NS: Field<5, 1> in STAGE1_LEAF;
        pub VMSA64_STAGE2_MEM_ATTR: Field<2, 4> in STAGE2_LEAF;
        pub VMSA64_PERMISSION_PRIMARY_LOW: Field<6, 1> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_PERMISSION_DIRTY: Field<7, 1> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_SHAREABILITY: Field<8, 2> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_ACCESS_FLAG: Field<10, 1> in ALL;
        ...
        pub VMSA64_PERMISSION_PRIMARY_1: Field<51, 1> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_CONTIGUOUS: Field<52, 1> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_PERMISSION_PRIMARY_2: Field<53, 1> in STAGE1_LEAF | STAGE2_LEAF;
        pub VMSA64_PERMISSION_PRIMARY_3: Field<54, 1> in STAGE1_LEAF | STAGE2_LEAF;
        ...
        pub VMSA64_PERMISSION_OVERLAY: Field<60, 3> in STAGE1_LEAF | STAGE2_LEAF;
    }
}
